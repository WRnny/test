//#include "interrupt.h"
//#include "clock.h"
//#include "../Hardware/wit.h"
//#include "../Hardware/Encoder.h"
//#include "../custom_definitions.h"
//volatile int encoder_l_count = 0, encoder_r_count = 0;
...
//        #endif
//    }
//	if (DL_GPIO_getEnabledInterruptStatus(Encoder_Left_B_PORT, Encoder_Left_B_PIN))
//    {
//        if(DL_GPIO_readPins(Encoder_Left_A_PORT, Encoder_Left_A_PIN) == 0) {
//            encoder_l_count++;
//        } else {
//            encoder_l_count--;
//        }
...
//    {
//        if(DL_GPIO_readPins(Encoder_Right_A_PORT, Encoder_Right_A_PIN) == 0) {
//            encoder_r_count++;
//        } else {
//            encoder_r_count--;
//        }
